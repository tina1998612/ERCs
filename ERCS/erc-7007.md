...
description: An ERC-721 extension interface enabling AI-Generated Content Token to be verified via Zero-Knowledge Machine Learning (zkML) and Optimistic Machine Learning.
